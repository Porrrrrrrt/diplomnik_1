...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="src/logout.php">Выйти</a>
            </li>
        </ul>
    </div>
</nav>
...
<main id="js-page-content" role="main" class="page-content mt-3">
    <?php if(isset($_SESSION['validation']['user'])): ?>
    <div class="alert alert-success">
        <?php echo $_SESSION['validation']['user']?>
        <?php unset($_SESSION['validation']['user']) ?>
    </div>
    <?php endif; ?>
    <?php if(isset($_SESSION['validation']['avatar'])): ?>
        <div class="alert alert-success">
            <?php echo $_SESSION['validation']['avatar']?>
            <?php unset($_SESSION['validation']['avatar']) ?>
        </div>
    <?php endif; ?>
    <div class="subheader">
                ...
                <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['username']?>">
                        ...
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="info-card-text flex-1">
                                ...
                                <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <?php if($id===$user['id'] || is_admin($currentUser)):?>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="src/delete.php?id=<?php echo $user['id'] ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            ...
                            <a href="<?php echo $user['username']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
