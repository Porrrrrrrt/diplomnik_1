...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <div class="<?php echo validationErrorAttr('password','danger') ?>">
            <?php echo validationErrorMessage('password')?>
            </div>
            <?php endif; ?>
            <?php if(hasValidationError()): ?>
            <main id="js-page-content" role="main" class="page-content mt-3">
                <div class="<?php echo validationErrorAttr('email','danger') ?>">
                    <?php echo validationErrorMessage('email')?>
                </div>
                <?php endif; ?>
                <?php if(hasValidationError()): ?>
                <main id="js-page-content" role="main" class="page-content mt-3">
                    <div class="<?php echo validationErrorAttr('avatar','danger') ?>">
                        <?php echo validationErrorMessage('avatar')?>
                    </div>
                    <?php endif; ?>


        <form action="/src/create_user.php" method="post" enctype="multipart/form-data" >
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="avatar" a id="example-fileinput" class="form-control-file">
                                </div>
                            </div>
                        </div>
