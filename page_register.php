                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    <?php if(isset($_SESSION['validation']['danger'])): ?>
                                    <div class="alert alert-danger text-dark" role="alert">
                                        <?php echo $_SESSION['validation']['danger']?>
                                    </div>
                                    <?php endif; ?>
                                    <form id="js-login" novalidate="" action="src/register.php" method="post">
...
<?php
unset($_SESSION['validation']['danger']);
?>